 ...
 *
 * @ViewsField("pcx_checkout_view_employee_buying_power")
 */
class PCXCheckoutViewEmployeeBuyingPower extends FieldPluginBase {
  ...
  public function render(ResultRow $values) {
    ...
    $buying_power = pcx_checkout_get_employee_buying_power($user_id[0]['target_id']);
